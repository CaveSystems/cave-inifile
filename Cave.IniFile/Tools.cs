...
#error No code defined for the current framework or NETXX version define missing!
        ...
        /// <param name="cultureInfo">The culture to use during formatting.</param>
        public static void SetValues(ref object obj, IList<PropertyInfo> properties, IList<object> values, CultureInfo cultureInfo)
        {
            if (obj == null)
            {
            ...
            for (var i = 0; i < values.Count; i++)
            {
                ...
                var value = ConvertValue(property.PropertyType, values[i], cultureInfo);
